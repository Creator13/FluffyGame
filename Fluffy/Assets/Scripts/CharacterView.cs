    ...
    public class CharacterView : DialogueViewBase
    {
        ...
        private void Update()
        {
            ...
            if (dialogueBubbleRect.gameObject.activeInHierarchy)
            {
                ...
                {
                    dialogueBubbleRect.anchoredPosition = WorldToAnchoredPosition(
                        dialogueBubbleRect, speakerCharacter.PositionWithOffset, bubbleMargin);
                }
                else
                {
                    // if no speaker defined, then display speech above playerCharacter as a default
                    dialogueBubbleRect.anchoredPosition = WorldToAnchoredPosition(
                        dialogueBubbleRect, playerCharacter.PositionWithOffset, bubbleMargin);
                }
            }
            ...
            {
                optionsBubbleRect.anchoredPosition = WorldToAnchoredPosition(
                    optionsBubbleRect, playerCharacter.PositionWithOffset, bubbleMargin);
            }
        }
